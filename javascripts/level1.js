...
function nextLevel() {//游戏胜利 Game win
  		beforeBegin();
  		$("#start").html("OK");
  		$("#small").html("You won, play next?");
 		$('#start').click(function(){
 				$("#stage").css("background-image","url(images/GameBoard2.png)");
	$("#grid1").css({
	...
	"height":"383px"}
 			...
 			replacejscssfile("javascripts/level1.js", "javascripts/level2.js", "js");
...
$('#on').click(function(){
		...
		if (!$(this).hasClass('off')) {
			$(this).addClass("off");
			$(this).css("background-image","url(images/NoSound.png)");
